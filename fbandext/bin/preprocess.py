...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Preprocess audio and then extract features (See detail in fbandext/bin/preprocess.py).")
    ...
    for utt_id, wavfn in tqdm(wav_files.items()):
        ...
        if fs < sampling_rate:
            ...
            audio = librosa.resample(audio.T, orig_sr=fs, target_sr=sampling_rate, res_type="fft").T
